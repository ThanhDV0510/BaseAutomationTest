...
public class Form_CreateComplianceTest extends WebActions {

	public Form_CreateComplianceTest(WebDriver driver) {
		super(driver);
     }

	By lblCreateComplianceTest = By.xpath("//div[@id='create-compliance-test-box']//h4");
	
	public boolean isLblCreateComplianceTestlDisplayed()
	{
		boolean flag = false;
		try {
			if (driver.findElements(lblCreateComplianceTest).size() > 0) {
				flag = true;
			}
		} catch (Exception e) {
			return flag;
	...
	By drplistCategory = By.xpath("//div[@id='step1Content']//div[2]//div[2]//span[2]");
	By txtDescription = By.xpath("//div[@id='step1Content']//iframe");
	By btnThumbnail = By.id("upload-photo");
	...
	public void fillCategory(String category)
	{
		...
		click(lblCreateComplianceTest);
	}
	
	By btnNextInfo = By.xpath("(//div[@id='create-compliance-test-box']//div[@id='buttonStep1']//button)[2]");
	By btnCancelInfo = By.xpath("(//div[@id='create-compliance-test-box']//div[@id='buttonStep1']//button)[1]");
	...
	By lblRestriction = By.xpath("(//div[@id='step2Content']//label)[1]");
	...
	By drplistRestriction = By.xpath("(//div[@id='step2Content']/div[1]//span[2])[1]");
	...
	By drplistCompletionTime = By.xpath("(//div[@id='step2Content']/div[1]//span[2])[2]");
	...
	By drplistMarginTime = By.xpath("(//div[@id='step2Content']/div[1]//span[2])[3]");
	...
	By drplistPassingScore = By.xpath("(//div[@id='step2Content']/div[1]//span[2])[4]");
	...
	By btnRadioAssessmentSettings = By.xpath("(//div[@id='step2Content']/div[2]//span)[1]");
	By drplistTimes = By.xpath("(//div[@id='step2Content']/div[2]//span)[3]");
	By itemUnlimited = By.xpath("(//ul[@id='ddlTime_listbox'])/li[1]");
	...
	By drplistInterval = By.xpath("(//div[@id='step2Content']/div[2]//span//span)[6]");
	...
	By btnPause = By.xpath("(//div[@id='step2Content']/div[2]//label//span)[3]");
	...
	By btnRadioShuffleQuestion = By.xpath("(//div[@id='step2Content']/div[2]//label//span)[5]");
	By btnRadioShuffleAnswer = By.xpath("(//div[@id='step2Content']/div[2]//label//span)[57]");
	...
	By btnNextTesting = By.xpath("(//div[@id='create-compliance-test-box']//div[@id='buttonStep2']//button)[3]");
	By btnCancelTesting = By.xpath("(//div[@id='create-compliance-test-box']//div[@id='buttonStep2']//button)[1]");
	By btnBackTesting = By.xpath("(//div[@id='create-compliance-test-box']//div[@id='buttonStep2']//button)[2]");
	...
	By linkClickHere = By.xpath("//div[@id='step3Content']//a");
	By btnAddQuestion = By.xpath("//div[@id='step3Content']//button");
	...
	By btnSave = By.xpath("(//div[@id='create-compliance-test-box']//div[@id='buttonStep3']//button)[4]");
	By btnSaveAsTrial = By.xpath("(//div[@id='create-compliance-test-box']//div[@id='buttonStep3']//button)[3]");
	By btnCancelQuestion = By.xpath("(//div[@id='create-compliance-test-box']//div[@id='buttonStep3']//button)[1]");
	By btnBackQuestion = By.xpath("(//div[@id='create-compliance-test-box']//div[@id='buttonStep3']//button)[2]");
	...
	By lblAddQuestion = By.xpath("//div[@id='import-question']//h5");
	By txtSearchCategoryImport = By.xpath("//div[@id='questionCategory-screen']//input");
	By itemSearchFirstImport = By.xpath("(//ul[@id='searchTextCategory_listbox'])/li[1]");
	By itemFirstImport = By.xpath("(//div[@id='questionCategory-list-grid']//tr[2]//span[4])[1]");
	By txtSearchQuestionImport = By.xpath("(//div[@id='question-pool-grid']//th//input)[2]");
	By cboxAllImport = By.xpath("//div[@id='question-pool-grid']//th/label");
	By cboxImport1 = By.xpath("(//div[@id='question-pool-grid']//td/label)[1]");
	By cboxImport2 = By.xpath("(//div[@id='question-pool-grid']//td/label)[2]");
	
	public boolean isLblAddQuestionProfilelDisplayed()
	{
		boolean flag = false;
		try {
			if (driver.findElements(lblAddQuestion).size() > 0) {
				flag = true;
			}
		} catch (Exception e) {
			return flag;
	...
	public void clickCboxImport1()
	{
		waitFluentWait(cboxImport1);
		click(cboxImport1);
	}
	
	public void clickCboxImport2()
	{
		waitFluentWait(cboxImport2);
		click(cboxImport2);
	}
		
	By btnSaveImport = By.id("btnConfirm");
	By btnCancelImport = By.id("btnCancel");
	...
	By lblPreview = By.xpath("//div[@id='step3Content']//div[3]//h5");
	By iconDelete1 = By.xpath("(//div[@id='step3Content']//div[3]//i)[1]");
	By iconReplace = By.xpath("(//div[@id='step3Content']//div[3]//i)[2]");
	...
	By lblReplaceQuestion = By.xpath("//div[@id='changeQuestionTestSetting']//h5");
	...
	By itemFirstReplace = By.xpath("(//div[@id='changeQuestionCategoryTree']//tr[2]//span[4])[1]");
	By txtSearchQuestionReplace = By.xpath("(//div[@id='changeQuestionGrid']//th//input)[1]");
	By cboxFirstReplace = By.xpath("(//input[@id='radioSelectQuestion'])[1]");
